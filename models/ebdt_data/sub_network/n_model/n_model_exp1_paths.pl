...
0.501064571965118::p_function("PTK2(S722)",p_dec); 0.498935428034882::p_function("PTK2(S722)",p_inc).
0.500667424551175::p_function("ABL1(S718)",p_dec); 0.499332575448825::p_function("ABL1(S718)",p_inc).
0.498457225255163::p_function("PTPRG(S995)",p_dec); 0.501542774744837::p_function("PTPRG(S995)",p_inc).
0.500592535208948::p_function("PTK2(S29)",p_dec); 0.499407464791052::p_function("PTK2(S29)",p_inc).
0.5::p_function("RBM39(Y95)",p_dec); 0.5::p_function("RBM39(Y95)",p_inc).
0.5::p_function("ANXA2P2(Y24)",p_dec); 0.5::p_function("ANXA2P2(Y24)",p_inc).
0.5::p_function("PTTG1IP(Y174)",p_dec); 0.5::p_function("PTTG1IP(Y174)",p_inc).
0.5::p_function("BCLAF1(Y284)",p_dec); 0.5::p_function("BCLAF1(Y284)",p_inc).
0.5::p_function("ATF1(S198)",p_dec); 0.5::p_function("ATF1(S198)",p_inc).
0.001::occ_dec(P,S) :- phosphosite(P).
0.001::occ_inc(P,S) :- phosphosite(P).
0.001::occ_dec(P,S) :- targets(E,P).
0.001::occ_inc(P,S) :- targets(E,P).
0.814535808559159::occ_dec("ATF1(S198)",S) :- targets("HIPK2","ATF1(S198)"), e_function("HIPK2",kinase), e_activity("HIPK2",S,dec).
0.978018298854837::occ_dec("HIPK2(Y361)",S) :- targets("SRC","HIPK2(Y361)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.734494243796495::occ_dec("PTTG1IP(Y174)",S) :- targets("SRC","PTTG1IP(Y174)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.736926433020488::occ_dec("ANXA2P2(Y24)",S) :- targets("SRC","ANXA2P2(Y24)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.959608589778152::occ_dec("BCLAF1(Y284)",S) :- targets("SRC","BCLAF1(Y284)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.934639428732328::occ_dec("ABI1(Y213)",S) :- targets("ABL1","ABI1(Y213)"), e_function("ABL1",kinase), e_activity("ABL1",S,dec).
0.878865002421412::occ_dec("PXN(Y118)",S) :- targets("PTK6","PXN(Y118)"), e_function("PTK6",kinase), e_activity("PTK6",S,dec).
0.789224917552337::occ_dec("PXN(Y118)",S) :- targets("FYN","PXN(Y118)"), e_function("FYN",kinase), e_activity("FYN",S,dec).
0.900416011727161::occ_dec("PXN(Y118)",S) :- targets("PTK2","PXN(Y118)"), e_function("PTK2",kinase), e_activity("PTK2",S,dec).
0.799222188213467::occ_dec("PXN(Y118)",S) :- targets("ABL1","PXN(Y118)"), e_function("ABL1",kinase), e_activity("ABL1",S,dec).
0.81506284333479::occ_dec("PXN(Y118)",S) :- targets("SRC","PXN(Y118)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.947146633915482::occ_dec("PXN(Y88)",S) :- targets("SRC","PXN(Y88)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.873549005111598::occ_dec("RBM39(Y95)",S) :- targets("ABL1","RBM39(Y95)"), e_function("ABL1",kinase), e_activity("ABL1",S,dec).
0.855239842975312::occ_dec("PXN(Y118)",S) :- targets("PTPRG","PXN(Y118)"), e_function("PTPRG",phosphatase), e_activity("PTPRG",S,inc).
0.749988363985876::occ_dec("PXN(Y88)",S) :- targets("PTPRR","PXN(Y88)"), e_function("PTPRR",phosphatase), e_activity("PTPRR",S,inc).
0.866779167780524::occ_inc("ATF1(S198)",S) :- targets("HIPK2","ATF1(S198)"), e_function("HIPK2",kinase), e_activity("HIPK2",S,inc).
0.955380209220331::occ_inc("HIPK2(Y361)",S) :- targets("SRC","HIPK2(Y361)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.889647481338632::occ_inc("PTTG1IP(Y174)",S) :- targets("SRC","PTTG1IP(Y174)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.932427332574504::occ_inc("ANXA2P2(Y24)",S) :- targets("SRC","ANXA2P2(Y24)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.977429133373612::occ_inc("BCLAF1(Y284)",S) :- targets("SRC","BCLAF1(Y284)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.870851293410524::occ_inc("ABI1(Y213)",S) :- targets("ABL1","ABI1(Y213)"), e_function("ABL1",kinase), e_activity("ABL1",S,inc).
0.884194562690445::occ_inc("PXN(Y118)",S) :- targets("PTK6","PXN(Y118)"), e_function("PTK6",kinase), e_activity("PTK6",S,inc).
0.894556547231688::occ_inc("PXN(Y118)",S) :- targets("FYN","PXN(Y118)"), e_function("FYN",kinase), e_activity("FYN",S,inc).
0.893673756965322::occ_inc("PXN(Y118)",S) :- targets("PTK2","PXN(Y118)"), e_function("PTK2",kinase), e_activity("PTK2",S,inc).
0.883962561578994::occ_inc("PXN(Y118)",S) :- targets("ABL1","PXN(Y118)"), e_function("ABL1",kinase), e_activity("ABL1",S,inc).
0.801320203354673::occ_inc("PXN(Y118)",S) :- targets("SRC","PXN(Y118)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.965488215794717::occ_inc("PXN(Y88)",S) :- targets("SRC","PXN(Y88)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.870956612076449::occ_inc("RBM39(Y95)",S) :- targets("ABL1","RBM39(Y95)"), e_function("ABL1",kinase), e_activity("ABL1",S,inc).
0.831129943291434::occ_inc("PXN(Y118)",S) :- targets("PTPRG","PXN(Y118)"), e_function("PTPRG",phosphatase), e_activity("PTPRG",S,dec).
0.94924059266379::occ_inc("PXN(Y88)",S) :- targets("PTPRR","PXN(Y88)"), e_function("PTPRR",phosphatase), e_activity("PTPRR",S,dec).
...
1.0::p_occupancy("SRC(S17)",S,dec); 0.0::p_occupancy("SRC(S17)",S,inc) :- occ_dec("SRC(S17)",S), \+occ_inc("SRC(S17)",S).
1.0::p_occupancy("SRC(S75)",S,dec); 0.0::p_occupancy("SRC(S75)",S,inc) :- occ_dec("SRC(S75)",S), \+occ_inc("SRC(S75)",S).
...
1.0::p_occupancy("PTK2(S722)",S,dec); 0.0::p_occupancy("PTK2(S722)",S,inc) :- occ_dec("PTK2(S722)",S), \+occ_inc("PTK2(S722)",S).
1.0::p_occupancy("PTK2(S843)",S,dec); 0.0::p_occupancy("PTK2(S843)",S,inc) :- occ_dec("PTK2(S843)",S), \+occ_inc("PTK2(S843)",S).
1.0::p_occupancy("PTK2(S29)",S,dec); 0.0::p_occupancy("PTK2(S29)",S,inc) :- occ_dec("PTK2(S29)",S), \+occ_inc("PTK2(S29)",S).
1.0::p_occupancy("PTK2(S910)",S,dec); 0.0::p_occupancy("PTK2(S910)",S,inc) :- occ_dec("PTK2(S910)",S), \+occ_inc("PTK2(S910)",S).
...
1.0::p_occupancy("ABL1(S569)",S,dec); 0.0::p_occupancy("ABL1(S569)",S,inc) :- occ_dec("ABL1(S569)",S), \+occ_inc("ABL1(S569)",S).
1.0::p_occupancy("ABL1(S718)",S,dec); 0.0::p_occupancy("ABL1(S718)",S,inc) :- occ_dec("ABL1(S718)",S), \+occ_inc("ABL1(S718)",S).
1.0::p_occupancy("ABL1(T735)",S,dec); 0.0::p_occupancy("ABL1(T735)",S,inc) :- occ_dec("ABL1(T735)",S), \+occ_inc("ABL1(T735)",S).
1.0::p_occupancy("PTPRG(S995)",S,dec); 0.0::p_occupancy("PTPRG(S995)",S,inc) :- occ_dec("PTPRG(S995)",S), \+occ_inc("PTPRG(S995)",S).
...
0.0::p_occupancy("SRC(S17)",S,dec); 1.0::p_occupancy("SRC(S17)",S,inc) :- \+occ_dec("SRC(S17)",S), occ_inc("SRC(S17)",S).
0.0::p_occupancy("SRC(S75)",S,dec); 1.0::p_occupancy("SRC(S75)",S,inc) :- \+occ_dec("SRC(S75)",S), occ_inc("SRC(S75)",S).
...
0.0::p_occupancy("PTK2(S722)",S,dec); 1.0::p_occupancy("PTK2(S722)",S,inc) :- \+occ_dec("PTK2(S722)",S), occ_inc("PTK2(S722)",S).
0.0::p_occupancy("PTK2(S843)",S,dec); 1.0::p_occupancy("PTK2(S843)",S,inc) :- \+occ_dec("PTK2(S843)",S), occ_inc("PTK2(S843)",S).
0.0::p_occupancy("PTK2(S910)",S,dec); 1.0::p_occupancy("PTK2(S910)",S,inc) :- \+occ_dec("PTK2(S910)",S), occ_inc("PTK2(S910)",S).
0.0::p_occupancy("PTK2(S29)",S,dec); 1.0::p_occupancy("PTK2(S29)",S,inc) :- \+occ_dec("PTK2(S29)",S), occ_inc("PTK2(S29)",S).
0.0::p_occupancy("BCLAF1(Y284)",S,dec); 1.0::p_occupancy("BCLAF1(Y284)",S,inc) :- \+occ_dec("BCLAF1(Y284)",S), occ_inc("BCLAF1(Y284)",S).
0.0::p_occupancy("ABL1(T735)",S,dec); 1.0::p_occupancy("ABL1(T735)",S,inc) :- \+occ_dec("ABL1(T735)",S), occ_inc("ABL1(T735)",S).
0.0::p_occupancy("ABI1(Y213)",S,dec); 1.0::p_occupancy("ABI1(Y213)",S,inc) :- \+occ_dec("ABI1(Y213)",S), occ_inc("ABI1(Y213)",S).
0.0::p_occupancy("ABL1(S569)",S,dec); 1.0::p_occupancy("ABL1(S569)",S,inc) :- \+occ_dec("ABL1(S569)",S), occ_inc("ABL1(S569)",S).
0.0::p_occupancy("ABL1(S718)",S,dec); 1.0::p_occupancy("ABL1(S718)",S,inc) :- \+occ_dec("ABL1(S718)",S), occ_inc("ABL1(S718)",S).
0.0::p_occupancy("PTPRG(S995)",S,dec); 1.0::p_occupancy("PTPRG(S995)",S,inc) :- \+occ_dec("PTPRG(S995)",S), occ_inc("PTPRG(S995)",S).
...
0.288550716446061::p_occupancy("ATF1(S198)",S,dec); 0.71144928355394::p_occupancy("ATF1(S198)",S,inc) :- occ_dec("ATF1(S198)",S), occ_inc("ATF1(S198)",S).
0.789855954857326::p_occupancy("HIPK2(Y361)",S,dec); 0.210144045142674::p_occupancy("HIPK2(Y361)",S,inc) :- occ_dec("HIPK2(Y361)",S), occ_inc("HIPK2(Y361)",S).
0.384644725338429::p_occupancy("SRC(S17)",S,dec); 0.615355274661571::p_occupancy("SRC(S17)",S,inc) :- occ_dec("SRC(S17)",S), occ_inc("SRC(S17)",S).
0.466800264793802::p_occupancy("SRC(S75)",S,dec); 0.533199735206199::p_occupancy("SRC(S75)",S,inc) :- occ_dec("SRC(S75)",S), occ_inc("SRC(S75)",S).
0.263971054377473::p_occupancy("PTTG1IP(Y174)",S,dec); 0.736028945622527::p_occupancy("PTTG1IP(Y174)",S,inc) :- occ_dec("PTTG1IP(Y174)",S), occ_inc("PTTG1IP(Y174)",S).
0.176908823751981::p_occupancy("ANXA2P2(Y24)",S,dec); 0.823091176248019::p_occupancy("ANXA2P2(Y24)",S,inc) :- occ_dec("ANXA2P2(Y24)",S), occ_inc("ANXA2P2(Y24)",S).
0.685144476926459::p_occupancy("PTK2(S722)",S,dec); 0.314855523073541::p_occupancy("PTK2(S722)",S,inc) :- occ_dec("PTK2(S722)",S), occ_inc("PTK2(S722)",S).
0.106936174445074::p_occupancy("PTK2(S843)",S,dec); 0.893063825554926::p_occupancy("PTK2(S843)",S,inc) :- occ_dec("PTK2(S843)",S), occ_inc("PTK2(S843)",S).
0.197396199059299::p_occupancy("PTK2(S910)",S,dec); 0.802603800940701::p_occupancy("PTK2(S910)",S,inc) :- occ_dec("PTK2(S910)",S), occ_inc("PTK2(S910)",S).
0.236681327183844::p_occupancy("PTK2(S29)",S,dec); 0.763318672816156::p_occupancy("PTK2(S29)",S,inc) :- occ_dec("PTK2(S29)",S), occ_inc("PTK2(S29)",S).
0.521207338224811::p_occupancy("BCLAF1(Y284)",S,dec); 0.478792661775189::p_occupancy("BCLAF1(Y284)",S,inc) :- occ_dec("BCLAF1(Y284)",S), occ_inc("BCLAF1(Y284)",S).
0.570894165169044::p_occupancy("ABI1(Y213)",S,dec); 0.429105834830956::p_occupancy("ABI1(Y213)",S,inc) :- occ_dec("ABI1(Y213)",S), occ_inc("ABI1(Y213)",S).
0.629933239431168::p_occupancy("ABL1(S569)",S,dec); 0.370066760568832::p_occupancy("ABL1(S569)",S,inc) :- occ_dec("ABL1(S569)",S), occ_inc("ABL1(S569)",S).
0.650488389617864::p_occupancy("ABL1(S718)",S,dec); 0.349511610382136::p_occupancy("ABL1(S718)",S,inc) :- occ_dec("ABL1(S718)",S), occ_inc("ABL1(S718)",S).
0.258461494188973::p_occupancy("ABL1(T735)",S,dec); 0.741538505811027::p_occupancy("ABL1(T735)",S,inc) :- occ_dec("ABL1(T735)",S), occ_inc("ABL1(T735)",S).
0.505033683462028::p_occupancy("PXN(Y118)",S,dec); 0.494966316537972::p_occupancy("PXN(Y118)",S,inc) :- occ_dec("PXN(Y118)",S), occ_inc("PXN(Y118)",S).
0.628515196909776::p_occupancy("PTPRG(S995)",S,dec); 0.371484803090225::p_occupancy("PTPRG(S995)",S,inc) :- occ_dec("PTPRG(S995)",S), occ_inc("PTPRG(S995)",S).
0.249060120642811::p_occupancy("PXN(Y88)",S,dec); 0.750939879357189::p_occupancy("PXN(Y88)",S,inc) :- occ_dec("PXN(Y88)",S), occ_inc("PXN(Y88)",S).
0.728448650682556::p_occupancy("RBM39(Y95)",S,dec); 0.271551349317444::p_occupancy("RBM39(Y95)",S,inc) :- occ_dec("RBM39(Y95)",S), occ_inc("RBM39(Y95)",S).
0.0::p_occupancy("SRC(S75)",S,dec); 0.0::p_occupancy("SRC(S75)",S,inc) :- \+occ_dec("SRC(S75)",S), \+occ_inc("SRC(S75)",S).
0.0::p_occupancy("SRC(S17)",S,dec); 0.0::p_occupancy("SRC(S17)",S,inc) :- \+occ_dec("SRC(S17)",S), \+occ_inc("SRC(S17)",S).
...
0.0::p_occupancy("PTK2(S29)",S,dec); 0.0::p_occupancy("PTK2(S29)",S,inc) :- \+occ_dec("PTK2(S29)",S), \+occ_inc("PTK2(S29)",S).
0.0::p_occupancy("PTK2(S722)",S,dec); 0.0::p_occupancy("PTK2(S722)",S,inc) :- \+occ_dec("PTK2(S722)",S), \+occ_inc("PTK2(S722)",S).
0.0::p_occupancy("PTK2(S910)",S,dec); 0.0::p_occupancy("PTK2(S910)",S,inc) :- \+occ_dec("PTK2(S910)",S), \+occ_inc("PTK2(S910)",S).
0.0::p_occupancy("PTK2(S843)",S,dec); 0.0::p_occupancy("PTK2(S843)",S,inc) :- \+occ_dec("PTK2(S843)",S), \+occ_inc("PTK2(S843)",S).
0.0::p_occupancy("BCLAF1(Y284)",S,dec); 0.0::p_occupancy("BCLAF1(Y284)",S,inc) :- \+occ_dec("BCLAF1(Y284)",S), \+occ_inc("BCLAF1(Y284)",S).
0.0::p_occupancy("ABL1(S569)",S,dec); 0.0::p_occupancy("ABL1(S569)",S,inc) :- \+occ_dec("ABL1(S569)",S), \+occ_inc("ABL1(S569)",S).
0.0::p_occupancy("ABL1(S718)",S,dec); 0.0::p_occupancy("ABL1(S718)",S,inc) :- \+occ_dec("ABL1(S718)",S), \+occ_inc("ABL1(S718)",S).
0.0::p_occupancy("ABI1(Y213)",S,dec); 0.0::p_occupancy("ABI1(Y213)",S,inc) :- \+occ_dec("ABI1(Y213)",S), \+occ_inc("ABI1(Y213)",S).
0.0::p_occupancy("ABL1(T735)",S,dec); 0.0::p_occupancy("ABL1(T735)",S,inc) :- \+occ_dec("ABL1(T735)",S), \+occ_inc("ABL1(T735)",S).
0.0::p_occupancy("PTPRG(S995)",S,dec); 0.0::p_occupancy("PTPRG(S995)",S,inc) :- \+occ_dec("PTPRG(S995)",S), \+occ_inc("PTPRG(S995)",S).
...
0.881443244995319::act_dec("HIPK2",S) :- inhibits(S,"HIPK2").
0.967625820050233::act_dec("ABL1",S) :- inhibits(S,"ABL1").
0.9114189521847::act_dec("FYN",S) :- inhibits(S,"FYN").
0.969617298076483::act_dec("SRC",S) :- p_regulates("SRC(S75)","SRC"), p_function("SRC(S75)",p_inc), p_occupancy("SRC(S75)",S,dec).
0.953670611530422::act_dec("SRC",S) :- p_regulates("SRC(S17)","SRC"), p_function("SRC(S17)",p_inc), p_occupancy("SRC(S17)",S,dec).
0.954570950536702::act_dec("HIPK2",S) :- p_regulates("HIPK2(Y361)","HIPK2"), p_function("HIPK2(Y361)",p_inc), p_occupancy("HIPK2(Y361)",S,dec).
0.869448236491067::act_dec("PTK2",S) :- p_regulates("PTK2(S843)","PTK2"), p_function("PTK2(S843)",p_inc), p_occupancy("PTK2(S843)",S,dec).
0.848472841854909::act_dec("PTK2",S) :- p_regulates("PTK2(S910)","PTK2"), p_function("PTK2(S910)",p_inc), p_occupancy("PTK2(S910)",S,dec).
0.821301224194138::act_dec("PTK2",S) :- p_regulates("PTK2(S722)","PTK2"), p_function("PTK2(S722)",p_inc), p_occupancy("PTK2(S722)",S,dec).
0.848115781335072::act_dec("PTK2",S) :- p_regulates("PTK2(S29)","PTK2"), p_function("PTK2(S29)",p_inc), p_occupancy("PTK2(S29)",S,dec).
0.915755060841954::act_dec("ABL1",S) :- p_regulates("ABL1(S569)","ABL1"), p_function("ABL1(S569)",p_inc), p_occupancy("ABL1(S569)",S,dec).
0.896478496089259::act_dec("ABL1",S) :- p_regulates("ABL1(S718)","ABL1"), p_function("ABL1(S718)",p_inc), p_occupancy("ABL1(S718)",S,dec).
0.899581562908316::act_dec("PTPRG",S) :- p_regulates("PTPRG(S995)","PTPRG"), p_function("PTPRG(S995)",p_inc), p_occupancy("PTPRG(S995)",S,dec).
0.856134143611509::act_dec("PTK2",S) :- p_regulates("PTK2(S722)","PTK2"), p_function("PTK2(S722)",p_dec), p_occupancy("PTK2(S722)",S,inc).
0.874723436253506::act_dec("PTK2",S) :- p_regulates("PTK2(S29)","PTK2"), p_function("PTK2(S29)",p_dec), p_occupancy("PTK2(S29)",S,inc).
0.800652632127362::act_dec("ABL1",S) :- p_regulates("ABL1(T735)","ABL1"), p_function("ABL1(T735)",p_dec), p_occupancy("ABL1(T735)",S,inc).
0.947060389312322::act_dec("ABL1",S) :- p_regulates("ABL1(S718)","ABL1"), p_function("ABL1(S718)",p_dec), p_occupancy("ABL1(S718)",S,inc).
0.829631725946097::act_dec("PTPRG",S) :- p_regulates("PTPRG(S995)","PTPRG"), p_function("PTPRG(S995)",p_dec), p_occupancy("PTPRG(S995)",S,inc).
0.93017053239244::act_inc("SRC",S) :- p_regulates("SRC(S17)","SRC"), p_function("SRC(S17)",p_inc), p_occupancy("SRC(S17)",S,inc).
0.975240028270354::act_inc("SRC",S) :- p_regulates("SRC(S75)","SRC"), p_function("SRC(S75)",p_inc), p_occupancy("SRC(S75)",S,inc).
0.928207460254886::act_inc("HIPK2",S) :- p_regulates("HIPK2(Y361)","HIPK2"), p_function("HIPK2(Y361)",p_inc), p_occupancy("HIPK2(Y361)",S,inc).
0.827450176500315::act_inc("PTK2",S) :- p_regulates("PTK2(S843)","PTK2"), p_function("PTK2(S843)",p_inc), p_occupancy("PTK2(S843)",S,inc).
0.882448303444417::act_inc("PTK2",S) :- p_regulates("PTK2(S910)","PTK2"), p_function("PTK2(S910)",p_inc), p_occupancy("PTK2(S910)",S,inc).
0.883000527745744::act_inc("PTK2",S) :- p_regulates("PTK2(S722)","PTK2"), p_function("PTK2(S722)",p_inc), p_occupancy("PTK2(S722)",S,inc).
0.863839686992372::act_inc("PTK2",S) :- p_regulates("PTK2(S29)","PTK2"), p_function("PTK2(S29)",p_inc), p_occupancy("PTK2(S29)",S,inc).
0.918306528559414::act_inc("ABL1",S) :- p_regulates("ABL1(S718)","ABL1"), p_function("ABL1(S718)",p_inc), p_occupancy("ABL1(S718)",S,inc).
0.903673741749405::act_inc("ABL1",S) :- p_regulates("ABL1(S569)","ABL1"), p_function("ABL1(S569)",p_inc), p_occupancy("ABL1(S569)",S,inc).
0.858641547776438::act_inc("PTPRG",S) :- p_regulates("PTPRG(S995)","PTPRG"), p_function("PTPRG(S995)",p_inc), p_occupancy("PTPRG(S995)",S,inc).
0.893656998324191::act_inc("PTK2",S) :- p_regulates("PTK2(S29)","PTK2"), p_function("PTK2(S29)",p_dec), p_occupancy("PTK2(S29)",S,dec).
0.895084074946318::act_inc("PTK2",S) :- p_regulates("PTK2(S722)","PTK2"), p_function("PTK2(S722)",p_dec), p_occupancy("PTK2(S722)",S,dec).
0.898728308590903::act_inc("ABL1",S) :- p_regulates("ABL1(T735)","ABL1"), p_function("ABL1(T735)",p_dec), p_occupancy("ABL1(T735)",S,dec).
0.904825071186742::act_inc("ABL1",S) :- p_regulates("ABL1(S718)","ABL1"), p_function("ABL1(S718)",p_dec), p_occupancy("ABL1(S718)",S,dec).
0.843788013349349::act_inc("PTPRG",S) :- p_regulates("PTPRG(S995)","PTPRG"), p_function("PTPRG(S995)",p_dec), p_occupancy("PTPRG(S995)",S,dec).
...
1.0::e_activity("PTPRR",S,dec); 0.0::e_activity("PTPRR",S,inc) :- act_dec("PTPRR",S), \+act_inc("PTPRR",S).
1.0::e_activity("PTK2",S,dec); 0.0::e_activity("PTK2",S,inc) :- act_dec("PTK2",S), \+act_inc("PTK2",S).
1.0::e_activity("PTK6",S,dec); 0.0::e_activity("PTK6",S,inc) :- act_dec("PTK6",S), \+act_inc("PTK6",S).
...
0.0::e_activity("PTPRR",S,dec); 1.0::e_activity("PTPRR",S,inc) :- \+act_dec("PTPRR",S), act_inc("PTPRR",S).
0.0::e_activity("PTK2",S,dec); 1.0::e_activity("PTK2",S,inc) :- \+act_dec("PTK2",S), act_inc("PTK2",S).
0.0::e_activity("PTK6",S,dec); 1.0::e_activity("PTK6",S,inc) :- \+act_dec("PTK6",S), act_inc("PTK6",S).
...
0.496723889466201::e_activity("SRC",S,dec); 0.503276110533799::e_activity("SRC",S,inc) :- act_dec("SRC",S), act_inc("SRC",S).
0.084680902124247::e_activity("HIPK2",S,dec); 0.915319097875753::e_activity("HIPK2",S,inc) :- act_dec("HIPK2",S), act_inc("HIPK2",S).
0.70424356554163::e_activity("PTPRR",S,dec); 0.29575643445837::e_activity("PTPRR",S,inc) :- act_dec("PTPRR",S), act_inc("PTPRR",S).
0.453226372674286::e_activity("PTK2",S,dec); 0.546773627325714::e_activity("PTK2",S,inc) :- act_dec("PTK2",S), act_inc("PTK2",S).
0.722230464100938::e_activity("PTK6",S,dec); 0.277769535899062::e_activity("PTK6",S,inc) :- act_dec("PTK6",S), act_inc("PTK6",S).
0.415467498143964::e_activity("ABL1",S,dec); 0.584532501856036::e_activity("ABL1",S,inc) :- act_dec("ABL1",S), act_inc("ABL1",S).
0.491324026220399::e_activity("PTPRG",S,dec); 0.508675973779601::e_activity("PTPRG",S,inc) :- act_dec("PTPRG",S), act_inc("PTPRG",S).
0.279595241775612::e_activity("FYN",S,dec); 0.720404758224388::e_activity("FYN",S,inc) :- act_dec("FYN",S), act_inc("FYN",S).
...
0.0::e_activity("PTPRR",S,dec); 0.0::e_activity("PTPRR",S,inc) :- \+act_dec("PTPRR",S), \+act_inc("PTPRR",S).
0.0::e_activity("PTK2",S,dec); 0.0::e_activity("PTK2",S,inc) :- \+act_dec("PTK2",S), \+act_inc("PTK2",S).
0.0::e_activity("PTK6",S,dec); 0.0::e_activity("PTK6",S,inc) :- \+act_dec("PTK6",S), \+act_inc("PTK6",S).
...
% path(D, P) :- inhibits(D, E), path(E, P).
% path(E, P) :- targets(E, P).
% path(E, P) :- targets(E, P), path(P, E).
% path(P, E) :- p_regulates(P, E).
% path(P, E) :- p_regulates(P, E), path(E, P).

% query(path("Dasatinib", "ABI1(Y213)")).


% Custom reverse predicate
reverse(List, Rev) :-
...
% Start of the path when a drug inhibits an event.
path(D, P, [D-E|Path]) :-
    inhibits(D, E),
    path(E, P, Path).
path(E, P, [E-P]) :- 
...
% If there's a path from the event back to a protein.
path(E, P, [E-P|Path]) :-
    targets(E, P),
    path(P, E, Path).

% If a protein regulates an event.
path(P, E, [P-E|Path]) :-
    p_regulates(P, E),
    path(E, P, Path).

% Helper to initiate the path.
find_path(Start, End, Path) :-
    path(Start, End, RevPath),
    reverse(RevPath, Path).

% Base case to stop the recursion if the start and end are the same.
path(E, E, []).

% Base case to handle a dead-end in the path.
path(_, _, []).



query(find_path(Drug, Kinase, Path)).