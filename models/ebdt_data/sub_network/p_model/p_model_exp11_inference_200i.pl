...
0.210008681119018::e_activity("SRC","GDC0941",dec); 0.789991318880982::e_activity("SRC","GDC0941",inc) :- enzyme("SRC").
...
0.733701778274931::e_activity("SRC","GSK2334470",dec); 0.266298221725069::e_activity("SRC","GSK2334470",inc) :- enzyme("SRC").
0.251732657807427::e_activity("ABL1","GSK2334470",dec); 0.748267342192573::e_activity("ABL1","GSK2334470",inc) :- enzyme("ABL1").
...
0.286488089764117::e_activity("ABL1","AZD5363",dec); 0.713511910235883::e_activity("ABL1","AZD5363",inc) :- enzyme("ABL1").
...
0.184463938703824::e_activity("SRC","LY2090314",dec); 0.815536061296176::e_activity("SRC","LY2090314",inc) :- enzyme("SRC").
...
0.767916702781203::e_activity("SRC","AZD3759",dec); 0.232083297218797::e_activity("SRC","AZD3759",inc) :- enzyme("SRC").
...
0.223895566719832::e_activity("HIPK2","Ribociclib",dec); 0.776104433280168::e_activity("HIPK2","Ribociclib",inc) :- enzyme("HIPK2").
...
0.911241970161112::e_activity("HIPK2","Ulixertinib",dec); 0.088758029838888::e_activity("HIPK2","Ulixertinib",inc) :- enzyme("HIPK2").
...
0.012487732229385::e_activity("SRC","Dabrafenib",dec); 0.987512267770615::e_activity("SRC","Dabrafenib",inc) :- enzyme("SRC").
...
0.191101870174119::e_activity("SRC","LY2584702",dec); 0.808898129825881::e_activity("SRC","LY2584702",inc) :- enzyme("SRC").
...
0.675638804972473::e_activity("HIPK2","AZ20",dec); 0.324361195027527::e_activity("HIPK2","AZ20",inc) :- enzyme("HIPK2").
0.0::e_activity("SRC","AZD8055",dec); 1.0::e_activity("SRC","AZD8055",inc) :- enzyme("SRC").
0.411720786633985::e_activity("ABL1","AZD8055",dec); 0.588279213366015::e_activity("ABL1","AZD8055",inc) :- enzyme("ABL1").
...
0.829806314546209::e_activity("ABL1","GO6983",dec); 0.170193685453792::e_activity("ABL1","GO6983",inc) :- enzyme("ABL1").
...
0.947291871817073::e_activity("ABL1","PH797804",dec); 0.052708128182928::e_activity("ABL1","PH797804",inc) :- enzyme("ABL1").
...
0.768065994267616::e_activity("ABL1","LY2835219",dec); 0.231934005732384::e_activity("ABL1","LY2835219",inc) :- enzyme("ABL1").
...
0.434723848468703::e_activity("ABL1","KD025",dec); 0.565276151531297::e_activity("ABL1","KD025",inc) :- enzyme("ABL1").
...
0.543959565121258::e_activity("HIPK2","KD025",dec); 0.456040434878743::e_activity("HIPK2","KD025",inc) :- enzyme("HIPK2").
...
0.999642493030365::e_activity("SRC","AZD1480",dec); 0.000357506969635::e_activity("SRC","AZD1480",inc) :- enzyme("SRC").
...
0.654320864663244::e_activity("ABL1","PF3758309",dec); 0.345679135336756::e_activity("ABL1","PF3758309",inc) :- enzyme("ABL1").
...
0.566024344782335::e_activity("ABL1","Trametinib",dec); 0.433975655217665::e_activity("ABL1","Trametinib",inc) :- enzyme("ABL1").
...
0.918022376669871::e_activity("SRC","BX912",dec); 0.081977623330129::e_activity("SRC","BX912",inc) :- enzyme("SRC").
...
0.315260653495241::e_activity("HIPK2","U73122",dec); 0.684739346504759::e_activity("HIPK2","U73122",inc) :- enzyme("HIPK2").
0.999996652586866::e_activity("SRC","Linsitinib",dec); 3.347413134e-06::e_activity("SRC","Linsitinib",inc) :- enzyme("SRC").
...
0.456891754851243::e_activity("HIPK2","Linsitinib",dec); 0.543108245148757::e_activity("HIPK2","Linsitinib",inc) :- enzyme("HIPK2").
...
0.472582692357923::e_activity("ABL1","JNK",dec); 0.527417307642077::e_activity("ABL1","JNK",inc) :- enzyme("ABL1").
...
0.409447846225579::e_activity("ABL1","Vemurafenib",dec); 0.590552153774421::e_activity("ABL1","Vemurafenib",inc) :- enzyme("ABL1").
...
0.999999938632356::occ_dec("PTTG1IP(Y174)",S) :- targets("SRC","PTTG1IP(Y174)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
...
0.99999999383085::occ_dec("ANXA2P2(Y24)",S) :- targets("SRC","ANXA2P2(Y24)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.0::occ_dec("PXN(Y118)",S) :- targets("PTK6","PXN(Y118)"), e_function("PTK6",kinase), e_activity("PTK6",S,dec).
0.738353533695694::occ_dec("PXN(Y118)",S) :- targets("ABL1","PXN(Y118)"), e_function("ABL1",kinase), e_activity("ABL1",S,dec).
...
3.7703909719e-05::occ_dec("PXN(Y118)",S) :- targets("PTK2","PXN(Y118)"), e_function("PTK2",kinase), e_activity("PTK2",S,dec).
...
0.999902121710528::occ_dec("HIPK2(Y361)",S) :- targets("SRC","HIPK2(Y361)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
0.999999999961665::occ_dec("HIPK2(Y361)",S) :- targets("HIPK2","HIPK2(Y361)"), e_function("HIPK2",kinase), e_activity("HIPK2",S,dec).
0.378647450451018::occ_dec("PXN(Y88)",S) :- targets("PTPRR","PXN(Y88)"), e_function("PTPRR",phosphatase), e_activity("PTPRR",S,inc).
...
0.496592460207384::occ_inc("PXN(Y118)",S) :- targets("PTK6","PXN(Y118)"), e_function("PTK6",kinase), e_activity("PTK6",S,inc).
0.998976256373531::occ_inc("PXN(Y118)",S) :- targets("FYN","PXN(Y118)"), e_function("FYN",kinase), e_activity("FYN",S,inc).
0.789332247049046::occ_inc("PXN(Y118)",S) :- targets("PTK2","PXN(Y118)"), e_function("PTK2",kinase), e_activity("PTK2",S,inc).
0.755142407431487::occ_inc("PXN(Y118)",S) :- targets("ABL1","PXN(Y118)"), e_function("ABL1",kinase), e_activity("ABL1",S,inc).
0.447164058887823::occ_inc("PXN(Y118)",S) :- targets("SRC","PXN(Y118)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
...
0.999999965424238::occ_inc("HIPK2(Y361)",S) :- targets("HIPK2","HIPK2(Y361)"), e_function("HIPK2",kinase), e_activity("HIPK2",S,inc).
0.825741813604528::occ_inc("HIPK2(Y361)",S) :- targets("SRC","HIPK2(Y361)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.338331234470166::occ_inc("PXN(Y88)",S) :- targets("PTPRR","PXN(Y88)"), e_function("PTPRR",phosphatase), e_activity("PTPRR",S,dec).
0.18459106680519::occ_inc("PXN(Y118)",S) :- targets("PTPRG","PXN(Y118)"), e_function("PTPRG",phosphatase), e_activity("PTPRG",S,dec).
