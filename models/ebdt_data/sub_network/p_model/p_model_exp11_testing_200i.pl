...
0.210522666966283::e_activity("SRC","GDC0941",dec); 0.789477333033717::e_activity("SRC","GDC0941",inc) :- enzyme("SRC").
...
0.733591075602343::e_activity("SRC","GSK2334470",dec); 0.266408924397657::e_activity("SRC","GSK2334470",inc) :- enzyme("SRC").
0.368372226454016::e_activity("ABL1","GSK2334470",dec); 0.631627773545984::e_activity("ABL1","GSK2334470",inc) :- enzyme("ABL1").
...
0.286488089764118::e_activity("ABL1","AZD5363",dec); 0.713511910235882::e_activity("ABL1","AZD5363",inc) :- enzyme("ABL1").
...
0.184706426160257::e_activity("SRC","LY2090314",dec); 0.815293573839743::e_activity("SRC","LY2090314",inc) :- enzyme("SRC").
...
0.77395902747134::e_activity("SRC","AZD3759",dec); 0.22604097252866::e_activity("SRC","AZD3759",inc) :- enzyme("SRC").
...
0.223895566723768::e_activity("HIPK2","Ribociclib",dec); 0.776104433276232::e_activity("HIPK2","Ribociclib",inc) :- enzyme("HIPK2").
...
0.012381748521594::e_activity("SRC","Dabrafenib",dec); 0.987618251478406::e_activity("SRC","Dabrafenib",inc) :- enzyme("SRC").
...
0.191101507941687::e_activity("SRC","LY2584702",dec); 0.808898492058313::e_activity("SRC","LY2584702",inc) :- enzyme("SRC").
...
0.67674443140211::e_activity("HIPK2","AZ20",dec); 0.32325556859789::e_activity("HIPK2","AZ20",inc) :- enzyme("HIPK2").
...
0.947291865556254::e_activity("ABL1","PH797804",dec); 0.052708134443746::e_activity("ABL1","PH797804",inc) :- enzyme("ABL1").
...
0.999637694986009::e_activity("SRC","AZD1480",dec); 0.000362305013991::e_activity("SRC","AZD1480",inc) :- enzyme("SRC").
...
0.610788467098784::e_activity("ABL1","PF3758309",dec); 0.389211532901216::e_activity("ABL1","PF3758309",inc) :- enzyme("ABL1").
...
0.893771058608324::e_activity("ABL1","Trametinib",dec); 0.106228941391676::e_activity("ABL1","Trametinib",inc) :- enzyme("ABL1").
...
0.91800762956139::e_activity("SRC","BX912",dec); 0.08199237043861::e_activity("SRC","BX912",inc) :- enzyme("SRC").
...
0.315260653486236::e_activity("HIPK2","U73122",dec); 0.684739346513764::e_activity("HIPK2","U73122",inc) :- enzyme("HIPK2").
...
0.458588493181714::e_activity("HIPK2","Linsitinib",dec); 0.541411506818286::e_activity("HIPK2","Linsitinib",inc) :- enzyme("HIPK2").
...
0.999999999659296::occ_dec("PTTG1IP(Y174)",S) :- targets("SRC","PTTG1IP(Y174)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
...
0.999999992315999::occ_dec("ANXA2P2(Y24)",S) :- targets("SRC","ANXA2P2(Y24)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
...
0.963932678377654::occ_dec("PXN(Y118)",S) :- targets("PTK2","PXN(Y118)"), e_function("PTK2",kinase), e_activity("PTK2",S,dec).
0.000706457766227::occ_dec("PXN(Y118)",S) :- targets("ABL1","PXN(Y118)"), e_function("ABL1",kinase), e_activity("ABL1",S,dec).
...
0.994448174797399::occ_dec("HIPK2(Y361)",S) :- targets("SRC","HIPK2(Y361)"), e_function("SRC",kinase), e_activity("SRC",S,dec).
1.0::occ_dec("HIPK2(Y361)",S) :- targets("HIPK2","HIPK2(Y361)"), e_function("HIPK2",kinase), e_activity("HIPK2",S,dec).
0.439117642851453::occ_dec("PXN(Y88)",S) :- targets("PTPRR","PXN(Y88)"), e_function("PTPRR",phosphatase), e_activity("PTPRR",S,inc).
...
0.517115126054531::occ_inc("PXN(Y118)",S) :- targets("PTK6","PXN(Y118)"), e_function("PTK6",kinase), e_activity("PTK6",S,inc).
0.976394867476105::occ_inc("PXN(Y118)",S) :- targets("FYN","PXN(Y118)"), e_function("FYN",kinase), e_activity("FYN",S,inc).
0.83854434571318::occ_inc("PXN(Y118)",S) :- targets("PTK2","PXN(Y118)"), e_function("PTK2",kinase), e_activity("PTK2",S,inc).
0.838881445131339::occ_inc("PXN(Y118)",S) :- targets("ABL1","PXN(Y118)"), e_function("ABL1",kinase), e_activity("ABL1",S,inc).
0.60871972545407::occ_inc("PXN(Y118)",S) :- targets("SRC","PXN(Y118)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
...
0.999999997801192::occ_inc("HIPK2(Y361)",S) :- targets("HIPK2","HIPK2(Y361)"), e_function("HIPK2",kinase), e_activity("HIPK2",S,inc).
0.794300946898889::occ_inc("HIPK2(Y361)",S) :- targets("SRC","HIPK2(Y361)"), e_function("SRC",kinase), e_activity("SRC",S,inc).
0.400020686291327::occ_inc("PXN(Y88)",S) :- targets("PTPRR","PXN(Y88)"), e_function("PTPRR",phosphatase), e_activity("PTPRR",S,dec).
0.321753604467324::occ_inc("PXN(Y118)",S) :- targets("PTPRG","PXN(Y118)"), e_function("PTPRG",phosphatase), e_activity("PTPRG",S,dec).
